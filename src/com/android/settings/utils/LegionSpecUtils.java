...
public class LegionSpecUtils {
    private static final String DEVICE_NAME_MODEL_PROPERTY = "ro.product.system.model";
    private static final String LEGION_CPU_MODEL_PROPERTY = "ro.legion.cpu";
    ...
    public static String getProcessorModel() {
        String cpuModelLegion = SystemProperties.get(LEGION_CPU_MODEL_PROPERTY);
        String cpuModelFallback = SystemProperties.get(FALLBACK_CPU_MODEL_PROPERTY);
        if (!cpuModelLegion.isEmpty()) {
            return cpuModelLegion;
